...
class Permisos extends Controllers
{
    ...
    public function getPermisos()
    {
        ...
        $arrData = $this->model->selectPermisos();
        ...
        for ($i = 0; $i < count($arrData); $i++) {
            ...
            <span style="cursor:pointer; color:blue; font-size:25px;" class="btnSeleccionarPerfil" title="Seleccionar perfil""><i class="ri-check-double-fill"></i></span>
