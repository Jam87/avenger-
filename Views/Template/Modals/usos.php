<div id="modalUsos" class="modal zoomIn" tabindex="-1" aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 overflow-hidden">
            ...
            <div class="modal-body">
                <form method="post" id="formUsos" name="formUsos">

                    <input type="hidden" id="idUsos" name="idUsos" value="">
