...
class ProveedoresModel extends Mysql
{
    ...
    {
        $sql = "SELECT MAX(consecutivo) as ultimo_consecutivo FROM pruchase_proveedor_bancos";
    ...
    public function insertBancoProveedor(int $Banco, int $consecutivo, int $moneda, string $nCuenta, string $swift)
    {
        ...
        #Sentencia
        $sql = "SELECT * FROM pruchase_proveedor_bancos WHERE numero_cuenta = '{$this->numero_cuenta}' OR codigo_swift = '{$this->codigo_swift}' ";
    ...
    public function insertContactoProveedor(int $movil, int $telefono, string $correo, int $extension, string $direccion)
    {
        ...
        #Sentencia
        $sql = "SELECT * FROM pruchase_proveedor_contacto WHERE telefono = $this->telefono OR correo  = '{$this->correo}'";
